...
class RegistrerType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('password', PasswordType::class, ['label' => 'Votre Mot De Passe', 'attr' => ['placeholder'=>'Mot De Passe']])//passwordType, permet de mettre des petits points ds le champs au lieu
