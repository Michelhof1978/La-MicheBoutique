    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('lastName', TextType::class, [
                'constraints'=> @Assert\Length(min=2,max=20, minMessage="Nombre de caractères insuffisants",maxMessage="Maximum de caractères atteints"),//mn et max de caractères
                'label' => 'Votre Nom', 
                'attr' => ['placeholder'=>'Nom']])
           
            ->add('email', EmailType::class, [
                'constraints'=> new Length(2,60),//mn et max de caractères
                'label' => 'Votre Email',
