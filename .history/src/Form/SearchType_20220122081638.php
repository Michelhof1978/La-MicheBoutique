...
class SearchType extends AbstractType
{
    ...
    {
        $builder
            ->add ('string', TextType::class), [// recherche en string de mes utilisatuers
                'label'  => 'Rechercher',
    ...
    public function getBlockPrefi() //pour eviter de retourner un tableau qui va appeler la classe search donc, tu me retourne rien
    {
        return '';
    }
}