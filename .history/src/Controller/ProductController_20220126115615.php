...
class ProductController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid())
        {
            ...
            $products = $this->entityManager->getRepository(Product::class)->findWithSearch($search); //retourner simple le produit recherché
// comme findWithSearch n existe pas, il va falloir le créer manuellement ds ProductRepository.php
