...
class RegistrerController extends AbstractController
{
     ...
     */
    public function index(Request $request, EntityManager $entityManager):response//use Symfony\Component\HttpFoundation\Request; // faire appel à EntityManager pour envoyer info à laBdd
    {
