...
class RegistrerController extends AbstractController
{
     ...
     */
    public function index(?User $user,Request $request, EntityManagerInterface $entityManager):response//use Symfony\Component\HttpFoundation\Request; // faire appel à EntityManager pour envoyer info à la Bdd
    {
