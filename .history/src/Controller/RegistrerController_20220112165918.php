...
use ContainerWDWFXlo\getEntityManagerService;
...
class RegistrerController extends AbstractController
{
     ...
     */
    public function index(Request $request):response//use Symfony\Component\HttpFoundation\Request; // faire appel à EntityManager pour envoyer info à la Bdd
    {
